...
@Client.on_message(command(["mplay","شغيل","شغيل اغنيه","play","شغل","غل" f"mplay@{BOT_USERNAME}"]) & other_filters)
                    ...
                    if veez == 0:
                        ...
                        if chat_id in QUEUE:
                            ...
                            try:
                                ...
                                await suhu.delete()
                                await m.reply_text(f"🚫 خطاء  قام احد مشرفي المجموعه بحظر الحساب المساعد برجاء رفع الحظر عنه @{ASSISTANT_NAME}")
